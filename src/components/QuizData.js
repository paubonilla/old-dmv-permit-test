export const QuizData = [
    ...
    {
        id: 18,
        question: `When making a right turn, look right and left, yield right-of-way, and turn the steering wheel using:`,
        options: [`Hand off hand technique`, `A double hand technique`, `Single hand technique`, `Hand over hand technique`],
        answer: `Hand over hand technique`
    },
    {
        id: 19,
        question: `If you approach an intersection at which the traffic lights are not working, you must first _______ for entering the intersection and yield the right of way.`,
        options: [`Turn on emergency lights`, `Reduce your speed`, `Come to a complete stop`, `Increase your speed`],
        answer: `Come to a complete stop`
    },
    {
        id: 20,
        question: `Must not pass another vehicle if you see:`,
        options: [`An approaching hill or curve where there is no clear visibility`, `Schoolbus ahead with red flashing lights and an extended`, `A solid yellow line in your lane`, `Any of the above situations`],
        answer: `Any of the above situations`
    },
]